...
public:
	...
	const ADDRESSING_TYPE OpcodeAddrTypes[0x100] =
	{
		...
		ADDR_REL, ADDR_INY, ADDR_NON, ADDR_NON, ADDR_NON, ADDR_ZEX, ADDR_ZEX, ADDR_NON, ADDR_IMP, ADDR_ABY, ADDR_NON, ADDR_NON, ADDR_NON, ADDR_ABX, ADDR_ABX, ADDR_NON,
		...
		ADDR_REL, ADDR_INY, ADDR_NON, ADDR_NON, ADDR_ZEX, ADDR_ZEX, ADDR_ZEY, ADDR_NON, ADDR_IMP, ADDR_ABY, ADDR_IMP, ADDR_NON, ADDR_NON, ADDR_ABX, ADDR_NON, ADDR_NON,
		ADDR_IMM, ADDR_INX, ADDR_IMM, ADDR_NON, ADDR_ZER, ADDR_ZER, ADDR_ZER, ADDR_NON, ADDR_IMP, ADDR_IMM, ADDR_IMM, ADDR_NON, ADDR_ABS, ADDR_ABS, ADDR_ABS, ADDR_NON,
		ADDR_REL, ADDR_INY, ADDR_NON, ADDR_NON, ADDR_ZEX, ADDR_ZEX, ADDR_ZEY, ADDR_NON, ADDR_IMP, ADDR_ABY, ADDR_IMP, ADDR_NON, ADDR_ABX, ADDR_ABX, ADDR_ABY, ADDR_NON,
